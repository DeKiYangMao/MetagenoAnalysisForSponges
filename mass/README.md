Use the python compiler to run the script "mass_data_align.py", then enter the path of mass spectrometry data set and a created results folder in the terminal, and run to get the alignment results.
